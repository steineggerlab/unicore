...
pub enum Commands {
    ...
    EasyCore {
        ...
        #[arg(short, long, default_value="false")]
        no_inference: bool,
        /// Choose which MSA to use for the tree reference
        /// 0: Only use amino acid MSA
        /// 1: Only use 3Di MSA
        /// 2: Use partition model of amino acid and 3Di MSA
...
impl Args {
    pub fn parse() -> Self {
        ...
        let tree_msa_for_tree = match &args.command {
            Some(Tree { msa_for_tree, .. }) => Some(*msa_for_tree),
            Some(EasyCore { msa_for_tree, .. }) => Some(*msa_for_tree),
            Some(EasySearch { msa_for_tree, .. }) => Some(*msa_for_tree), _ => None,
        };
        ...
        Args {
            ...
            tree_db, tree_input, tree_output, tree_aligner, tree_no_inference, tree_msa_for_tree, tree_tree_builder, tree_aligner_options, tree_tree_options, tree_threshold,
